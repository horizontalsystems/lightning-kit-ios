...
internal protocol Lnrpc_LightningSubscribePeerEventsCall: ClientCallServerStreaming {
  /// Do not call this directly, call `receive()` in the protocol extension below instead.
  func _receive(timeout: DispatchTime) throws -> Lnrpc_PeerEvent?
  /// Call this to wait for a result. Nonblocking.
  func receive(completion: @escaping (ResultOrRPCError<Lnrpc_PeerEvent?>) -> Void) throws
}

internal extension Lnrpc_LightningSubscribePeerEventsCall {
  /// Call this to wait for a result. Blocking.
  func receive(timeout: DispatchTime = .distantFuture) throws -> Lnrpc_PeerEvent? { return try self._receive(timeout: timeout) }
}

fileprivate final class Lnrpc_LightningSubscribePeerEventsCallBase: ClientCallServerStreamingBase<Lnrpc_PeerEventSubscription, Lnrpc_PeerEvent>, Lnrpc_LightningSubscribePeerEventsCall {
  override class var method: String { return "/lnrpc.Lightning/SubscribePeerEvents" }
}
...
internal protocol Lnrpc_LightningFundingStateStepCall: ClientCallUnary {}

fileprivate final class Lnrpc_LightningFundingStateStepCallBase: ClientCallUnaryBase<Lnrpc_FundingTransitionMsg, Lnrpc_FundingStateStepResp>, Lnrpc_LightningFundingStateStepCall {
  override class var method: String { return "/lnrpc.Lightning/FundingStateStep" }
}
...
internal protocol Lnrpc_LightningBakeMacaroonCall: ClientCallUnary {}

fileprivate final class Lnrpc_LightningBakeMacaroonCallBase: ClientCallUnaryBase<Lnrpc_BakeMacaroonRequest, Lnrpc_BakeMacaroonResponse>, Lnrpc_LightningBakeMacaroonCall {
  override class var method: String { return "/lnrpc.Lightning/BakeMacaroon" }
}
...
internal protocol Lnrpc_LightningService: ServiceClient {
  ...
  /// Send the initial message.
  /// Use methods on the returned object to get streamed responses.
  func subscribePeerEvents(_ request: Lnrpc_PeerEventSubscription, metadata customMetadata: Metadata, completion: ((CallResult) -> Void)?) throws -> Lnrpc_LightningSubscribePeerEventsCall
  ...
  /// Synchronous. Unary.
  func fundingStateStep(_ request: Lnrpc_FundingTransitionMsg, metadata customMetadata: Metadata) throws -> Lnrpc_FundingStateStepResp
  /// Asynchronous. Unary.
  @discardableResult
  func fundingStateStep(_ request: Lnrpc_FundingTransitionMsg, metadata customMetadata: Metadata, completion: @escaping (Lnrpc_FundingStateStepResp?, CallResult) -> Void) throws -> Lnrpc_LightningFundingStateStepCall
  ...
  /// Synchronous. Unary.
  func bakeMacaroon(_ request: Lnrpc_BakeMacaroonRequest, metadata customMetadata: Metadata) throws -> Lnrpc_BakeMacaroonResponse
  /// Asynchronous. Unary.
  @discardableResult
  func bakeMacaroon(_ request: Lnrpc_BakeMacaroonRequest, metadata customMetadata: Metadata, completion: @escaping (Lnrpc_BakeMacaroonResponse?, CallResult) -> Void) throws -> Lnrpc_LightningBakeMacaroonCall
...
internal extension Lnrpc_LightningService {
  ...
  /// Asynchronous. Server-streaming.
  func subscribePeerEvents(_ request: Lnrpc_PeerEventSubscription, completion: ((CallResult) -> Void)?) throws -> Lnrpc_LightningSubscribePeerEventsCall {
    return try self.subscribePeerEvents(request, metadata: self.metadata, completion: completion)
  }
  ...
  /// Synchronous. Unary.
  func fundingStateStep(_ request: Lnrpc_FundingTransitionMsg) throws -> Lnrpc_FundingStateStepResp {
    return try self.fundingStateStep(request, metadata: self.metadata)
  }
  /// Asynchronous. Unary.
  @discardableResult
  func fundingStateStep(_ request: Lnrpc_FundingTransitionMsg, completion: @escaping (Lnrpc_FundingStateStepResp?, CallResult) -> Void) throws -> Lnrpc_LightningFundingStateStepCall {
    return try self.fundingStateStep(request, metadata: self.metadata, completion: completion)
  }
  ...
  /// Synchronous. Unary.
  func bakeMacaroon(_ request: Lnrpc_BakeMacaroonRequest) throws -> Lnrpc_BakeMacaroonResponse {
    return try self.bakeMacaroon(request, metadata: self.metadata)
  }
  /// Asynchronous. Unary.
  @discardableResult
  func bakeMacaroon(_ request: Lnrpc_BakeMacaroonRequest, completion: @escaping (Lnrpc_BakeMacaroonResponse?, CallResult) -> Void) throws -> Lnrpc_LightningBakeMacaroonCall {
    return try self.bakeMacaroon(request, metadata: self.metadata, completion: completion)
  }
...
internal final class Lnrpc_LightningServiceClient: ServiceClientBase, Lnrpc_LightningService {
  ...
  /// Send the initial message.
  /// Use methods on the returned object to get streamed responses.
  internal func subscribePeerEvents(_ request: Lnrpc_PeerEventSubscription, metadata customMetadata: Metadata, completion: ((CallResult) -> Void)?) throws -> Lnrpc_LightningSubscribePeerEventsCall {
    return try Lnrpc_LightningSubscribePeerEventsCallBase(channel)
      .start(request: request, metadata: customMetadata, completion: completion)
  }
  ...
  /// Synchronous. Unary.
  internal func fundingStateStep(_ request: Lnrpc_FundingTransitionMsg, metadata customMetadata: Metadata) throws -> Lnrpc_FundingStateStepResp {
    return try Lnrpc_LightningFundingStateStepCallBase(channel)
      .run(request: request, metadata: customMetadata)
  }
  /// Asynchronous. Unary.
  @discardableResult
  internal func fundingStateStep(_ request: Lnrpc_FundingTransitionMsg, metadata customMetadata: Metadata, completion: @escaping (Lnrpc_FundingStateStepResp?, CallResult) -> Void) throws -> Lnrpc_LightningFundingStateStepCall {
    return try Lnrpc_LightningFundingStateStepCallBase(channel)
      .start(request: request, metadata: customMetadata, completion: completion)
  }
  ...
  /// Synchronous. Unary.
  internal func bakeMacaroon(_ request: Lnrpc_BakeMacaroonRequest, metadata customMetadata: Metadata) throws -> Lnrpc_BakeMacaroonResponse {
    return try Lnrpc_LightningBakeMacaroonCallBase(channel)
      .run(request: request, metadata: customMetadata)
  }
  /// Asynchronous. Unary.
  @discardableResult
  internal func bakeMacaroon(_ request: Lnrpc_BakeMacaroonRequest, metadata customMetadata: Metadata, completion: @escaping (Lnrpc_BakeMacaroonResponse?, CallResult) -> Void) throws -> Lnrpc_LightningBakeMacaroonCall {
    return try Lnrpc_LightningBakeMacaroonCallBase(channel)
      .start(request: request, metadata: customMetadata, completion: completion)
  }
...
internal protocol Lnrpc_LightningProvider: ServiceProvider {
  ...
  func subscribePeerEvents(request: Lnrpc_PeerEventSubscription, session: Lnrpc_LightningSubscribePeerEventsSession) throws -> ServerStatus?
  ...
  func fundingStateStep(request: Lnrpc_FundingTransitionMsg, session: Lnrpc_LightningFundingStateStepSession) throws -> Lnrpc_FundingStateStepResp
  func channelAcceptor(session: Lnrpc_LightningChannelAcceptorSession) throws -> ServerStatus?
  ...
  func bakeMacaroon(request: Lnrpc_BakeMacaroonRequest, session: Lnrpc_LightningBakeMacaroonSession) throws -> Lnrpc_BakeMacaroonResponse
}
    ...
    case "/lnrpc.Lightning/ListPeers":
      return try Lnrpc_LightningListPeersSessionBase(
        ...
        providerBlock: { try self.listPeers(request: $0, session: $1 as! Lnrpc_LightningListPeersSessionBase) })
          .run()
    case "/lnrpc.Lightning/SubscribePeerEvents":
      return try Lnrpc_LightningSubscribePeerEventsSessionBase(
        handler: handler,
        providerBlock: { try self.subscribePeerEvents(request: $0, session: $1 as! Lnrpc_LightningSubscribePeerEventsSessionBase) })
          .run()
    ...
    case "/lnrpc.Lightning/OpenChannel":
      return try Lnrpc_LightningOpenChannelSessionBase(
        ...
        providerBlock: { try self.openChannel(request: $0, session: $1 as! Lnrpc_LightningOpenChannelSessionBase) })
          .run()
    case "/lnrpc.Lightning/FundingStateStep":
      return try Lnrpc_LightningFundingStateStepSessionBase(
        handler: handler,
        providerBlock: { try self.fundingStateStep(request: $0, session: $1 as! Lnrpc_LightningFundingStateStepSessionBase) })
          .run()
    case "/lnrpc.Lightning/ChannelAcceptor":
      return try Lnrpc_LightningChannelAcceptorSessionBase(
        handler: handler,
        providerBlock: { try self.channelAcceptor(session: $0 as! Lnrpc_LightningChannelAcceptorSessionBase) })
          .run()
    ...
    case "/lnrpc.Lightning/SubscribeChannelBackups":
      return try Lnrpc_LightningSubscribeChannelBackupsSessionBase(
        ...
        providerBlock: { try self.subscribeChannelBackups(request: $0, session: $1 as! Lnrpc_LightningSubscribeChannelBackupsSessionBase) })
          .run()
    case "/lnrpc.Lightning/BakeMacaroon":
      return try Lnrpc_LightningBakeMacaroonSessionBase(
        handler: handler,
        providerBlock: { try self.bakeMacaroon(request: $0, session: $1 as! Lnrpc_LightningBakeMacaroonSessionBase) })
          .run()
    default:
      throw HandleMethodError.unknownMethod
    }
...
internal protocol Lnrpc_LightningSubscribePeerEventsSession: ServerSessionServerStreaming {
  /// Send a message to the stream. Nonblocking.
  func send(_ message: Lnrpc_PeerEvent, completion: @escaping (Error?) -> Void) throws
  /// Do not call this directly, call `send()` in the protocol extension below instead.
  func _send(_ message: Lnrpc_PeerEvent, timeout: DispatchTime) throws
...
internal extension Lnrpc_LightningSubscribePeerEventsSession {
  /// Send a message to the stream and wait for the send operation to finish. Blocking.
  func send(_ message: Lnrpc_PeerEvent, timeout: DispatchTime = .distantFuture) throws { try self._send(message, timeout: timeout) }
}

fileprivate final class Lnrpc_LightningSubscribePeerEventsSessionBase: ServerSessionServerStreamingBase<Lnrpc_PeerEventSubscription, Lnrpc_PeerEvent>, Lnrpc_LightningSubscribePeerEventsSession {}
...
internal protocol Lnrpc_LightningFundingStateStepSession: ServerSessionUnary {}

fileprivate final class Lnrpc_LightningFundingStateStepSessionBase: ServerSessionUnaryBase<Lnrpc_FundingTransitionMsg, Lnrpc_FundingStateStepResp>, Lnrpc_LightningFundingStateStepSession {}

internal protocol Lnrpc_LightningChannelAcceptorSession: ServerSessionBidirectionalStreaming {
  /// Do not call this directly, call `receive()` in the protocol extension below instead.
  func _receive(timeout: DispatchTime) throws -> Lnrpc_ChannelAcceptResponse?
  /// Call this to wait for a result. Nonblocking.
  func receive(completion: @escaping (ResultOrRPCError<Lnrpc_ChannelAcceptResponse?>) -> Void) throws

  /// Send a message to the stream. Nonblocking.
  func send(_ message: Lnrpc_ChannelAcceptRequest, completion: @escaping (Error?) -> Void) throws
  /// Do not call this directly, call `send()` in the protocol extension below instead.
  func _send(_ message: Lnrpc_ChannelAcceptRequest, timeout: DispatchTime) throws
...
internal extension Lnrpc_LightningChannelAcceptorSession {
  /// Call this to wait for a result. Blocking.
  func receive(timeout: DispatchTime = .distantFuture) throws -> Lnrpc_ChannelAcceptResponse? { return try self._receive(timeout: timeout) }
}

internal extension Lnrpc_LightningChannelAcceptorSession {
  /// Send a message to the stream and wait for the send operation to finish. Blocking.
  func send(_ message: Lnrpc_ChannelAcceptRequest, timeout: DispatchTime = .distantFuture) throws { try self._send(message, timeout: timeout) }
}

fileprivate final class Lnrpc_LightningChannelAcceptorSessionBase: ServerSessionBidirectionalStreamingBase<Lnrpc_ChannelAcceptResponse, Lnrpc_ChannelAcceptRequest>, Lnrpc_LightningChannelAcceptorSession {}
...
internal protocol Lnrpc_LightningBakeMacaroonSession: ServerSessionUnary {}

fileprivate final class Lnrpc_LightningBakeMacaroonSessionBase: ServerSessionUnaryBase<Lnrpc_BakeMacaroonRequest, Lnrpc_BakeMacaroonResponse>, Lnrpc_LightningBakeMacaroonSession {}
